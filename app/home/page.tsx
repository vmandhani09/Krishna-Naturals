 ...
 const [featuredProducts, setFeaturedProducts] = useState<Product[]>([]);
  ...
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-emerald-50 to-emerald-100 py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Premium quality nuts, dry fruits, seeds, and spices sourced directly from the finest farms. Experience
